...
public class ControlPanel extends JPanel implements ActionListener {
	...
	private void initGUI() {
		...
		_home = new JButton();
		//_home.setBackground(new Color(0, 9, 128));
		_home.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				MainWindow mainWindow = (MainWindow) SwingUtilities.getWindowAncestor(ControlPanel.this);
		...
		parkingButton = createButton("Parking", "icons/Parking_icon.svg.png", 150, 150);
		...
		clientesButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MainWindow mainWindow = (MainWindow) SwingUtilities.getWindowAncestor(ControlPanel.this);
				mainWindow.showBusquedaModPanel();
			}
		});
