 ...
 *
 * Interfaz gráfica para dar de alta un juego en el casino.
 * 
 */
public class AltaJuegoPanel extends JPanel{
	JTextField id;
	JTextField p;
	ControllerJuegos control;
	
	public AltaJuegoPanel(ControllerJuegos c) {
		control = c;
		initGUI();
	}
	...
	private void initGUI() {
		...
		botonAtras.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MainWindow mainWindow = (MainWindow) SwingUtilities.getWindowAncestor(AltaJuegoPanel.this);
		...
		JLabel labelT = new JLabel("PROBABILIDAD");
		...
		panelAuxB.add(crearBoton("Dar Alta Juego"), BorderLayout.PAGE_END);
	...
	private JButton crearBoton(String texto) {
		...
		b.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				if (!id.getText().isEmpty() && !p.getText().isEmpty()) {
					if(control.darAltaJuego(id.getText(), Integer.parseInt(p.getText()))) {
						ViewUtils.showSuccessMsg("Nuevo Juego A�adido");
					}else {
