...
public class SetProbabilidadPanel extends JPanel{
	JTextField id;
	JTextField t;
	ControllerJuegos control;
	
	public SetProbabilidadPanel(ControllerJuegos c) {
		control = c;
		initGUI();
	}
	...
	private void initGUI() {
		...
		botonAtras.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MainWindow mainWindow = (MainWindow) SwingUtilities.getWindowAncestor(SetProbabilidadPanel.this);
		...
		JLabel labelT = new JLabel("TIEMPO MAX");
		...
		panelAuxB.add(crearBoton("Cambiar TiempoMax"), BorderLayout.PAGE_END);
	...
	private JButton crearBoton(String texto) {
		...
		b.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				if (!id.getText().isEmpty() && !t.getText().isEmpty()) {
					if(control.setProbabilidad(id.getText(), Integer.parseInt(t.getText()))) {
						ViewUtils.showSuccessMsg("Probabilidad Cambiada");
					}else {
